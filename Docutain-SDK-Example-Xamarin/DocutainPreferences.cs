...
namespace Docutain_SDK_Example_Xamarin
{
    static public class DocutainPreferences
    {
        ...
        {
            Tuple.Create(ColorSettings.ColorPrimary.ToString(), Tuple.Create(Color.FromHex("#4CAF50"), Color.FromHex("#4CAF50"))),
            Tuple.Create(ColorSettings.ColorSecondary.ToString(),Tuple.Create(Color.FromHex("#4CAF50"), Color.FromHex("#4CAF50"))),
            Tuple.Create(ColorSettings.ColorOnSecondary.ToString(),Tuple.Create(Color.White, Color.Black)),
            Tuple.Create(ColorSettings.ColorScanButtonsLayoutBackground.ToString(),Tuple.Create(Color.FromHex("#121212"), Color.FromHex("#121212"))),
            Tuple.Create(ColorSettings.ColorScanButtonsForeground.ToString(),Tuple.Create(Color.White, Color.White)),
            Tuple.Create(ColorSettings.ColorScanPolygon.ToString(),Tuple.Create(Color.FromHex("#4CAF50"), Color.FromHex("#4CAF50"))),
            Tuple.Create(ColorSettings.ColorBottomBarBackground.ToString(),Tuple.Create(Color.White, Color.FromHex("#ff212121"))),
            Tuple.Create(ColorSettings.ColorBottomBarForeground.ToString(),Tuple.Create(Color.FromHex("#323232"), Color.FromHex("#ffbebebe"))),
            Tuple.Create(ColorSettings.ColorTopBarBackground.ToString(),Tuple.Create(Color.FromHex("#4CAF50"), Color.FromHex("#2a2a2a"))),
            Tuple.Create(ColorSettings.ColorTopBarForeground.ToString(),Tuple.Create(Color.White, Color.FromHex("#DEffffff")))
        };
        ...
        public static Tuple<Color, Color> Get(ColorSettings settings)
        {
            ...
            Color cLight = Color.FromHex(Preferences.Get(settings.ToString() + "_Light", defaultValue.Item2.Item1.ToHex()));
            Color cDark = Color.FromHex(Preferences.Get(settings.ToString() + "_Dark", defaultValue.Item2.Item2.ToHex()));
